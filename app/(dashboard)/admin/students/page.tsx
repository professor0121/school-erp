  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Students ({totalCount})</h1>
      ...
      {error ? (
        ...
        <DataTable 
          ...
          loading={loading}
          emptyMessage={searchTerm ? "No students found matching your search." : "No students available."}
        />
      )}
    </div>
  );
